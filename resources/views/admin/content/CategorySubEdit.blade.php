    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">ویرایش ساب منو {{$subcategory['name']}}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="container">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="post" action="{{route('SubCategoryUpdateOne')}}" role="form">
                            @method('patch')
                            @csrf
                            <input type="hidden" name="id" value="{{$subcategory['id']}}">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="nameinput">اسم زیر دسته بندی</label>
                                    <input type="text" name="name" class="form-control" id="nameinput" value="{{$subcategory['name']}}" ">
                                </div>
                                <div class="form-group">
                                    <label for="nameinput">آدرس زیر دسته بندی</label>
                                    <input type="text" name="slug" class="form-control" id="nameinput" value="{{$subcategory['slug']}}" ">
                                </div>
                                <div class="form-group">
                                    @php
                                     ...
                                     @endphp
                                    <label for="nameinput">   دسته بندی مادر انتخاب شده : </label>
