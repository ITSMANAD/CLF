                        ...
                        <form method="post" action="{{route('CategoryAddMegaOne')}}" role="form">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="nameinput" placeholder="نام را وارد کنید">
                                </div>
                                <div class="form-group">
                                    <label for="nameinput">آدرس مگا دسته بندی</label>
                                    <input type="text" name="slug" class="form-control" id="nameinput" placeholder="مانند : wordpress">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        @foreach($subcategories as $category)
                                            <input name="subcategory" class="form-check-input" type="radio" value="{{$category['id']}}">
