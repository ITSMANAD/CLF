                                    ...
                                    <div class="content-section default">
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-center">
                                                <a href="{{route('profile.edit')}}" class="btn-link-border form-account-link">
                                                    ویرایش اطلاعات شخصی
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="profile-recent-fav-row">
                                                    <a href="#" class="profile-recent-fav-col profile-recent-fav-col-thumb">
                                                        <img src="/CLF/assets/img/cart/4560621.jpg"></a>
                                                ...
                                                <div class="profile-recent-fav-row">
                                                    <a href="#" class="profile-recent-fav-col profile-recent-fav-col-thumb">
                                                        <img src="/CLF/assets/img/cart/3794614.jpg"></a>
                                                    <div class="profile-recent-fav-col profile-recent-fav-col-title">
                                                        <a href="#">
                                                            <h4 class="profile-recent-fav-name">
                                                                گوشی موبایل اپل مدل iPhone XR دو سیم کارت ظرفیت 256 گیگابایت
                            ...
                            <div class="profile-box">
                                <div class="profile-box-header">
                                    <div class="profile-box-avatar">
                                        <img src="/CLF/assets/img/svg/user.svg" alt="">
                                    </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <ul class="profile-avatars default text-center">
                                                        <li>
                                                            <img class="profile-avatars-item" src="/CLF/assets/img/svg/user.svg"></img>
                                                        </li>
                                                        <li>
                                                            <img class="profile-avatars-item" src="/CLF/assets/img/svg/avatar-1.svg"></img>
                                                        </li>
                                                        <li>
                                                            <img class="profile-avatars-item" src="/CLF/assets/img/svg/avatar-2.svg"></img>
                                                        </li>
                                                        <li>
                                                            <img class="profile-avatars-item" src="/CLF/assets/img/svg/avatar-3.svg"></img>
                                                        </li>
                                                        <li>
                                                            <img class="profile-avatars-item" src="/CLF/assets/img/svg/avatar-4.svg"></img>
                                                        </li>
                                                        <li>
                                                            <img class="profile-avatars-item" src="/CLF/assets/img/svg/avatar-5.svg"></img>
                                                        </li>
                                                        <li>
                                                            <img class="profile-avatars-item" src="/CLF/assets/img/svg/avatar-6.svg"></img>
                                                        </li>
                                                        <li>
                                                            <img class="profile-avatars-item" src="/CLF/assets/img/svg/avatar-7.svg"></img>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div class="responsive-profile-menu show-md">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right text-right">
                                        <a href="{{route('dashboard')}}" class="dropdown-item active-menu">
