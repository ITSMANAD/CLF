...
<head>
    ...
    <link href="/CLF/assets/css/now-ui-kit.css" rel="stylesheet" />
    <link href="/CLF/assets/css/plugins/owl.carousel.css" rel="stylesheet" />
    <link href="/CLF/assets/css/plugins/owl.theme.default.min.css" rel="stylesheet" />
    <link href="/CLF/assets/css/main.css" rel="stylesheet" />
    <link rel="stylesheet" href="/CLF/assets/fonts/font-awesome/css/font-awesome.min.css" />
    <style>
        body {
...
@foreach ($Settings['setting'] as $setting)
            ...
            <div class="navbar-translate">
                ...
                <div class="search-nav default w-75">
                    <form action="">
                        ...
                        <button type="submit"><img src="/CLF/assets/img/search.png" alt=""></button>
                    </form>
                    <ul>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="user-login dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink1">
                            <div class="dropdown-item">
                                <a href="{{route('dashboard')}}" class="btn btn-info">ورود به حساب</a>
                            </div>
                ...
                <ul class="list float-right">
                    <li class="list-item list-item-has-children mega-menu mega-menu-col-5">
                        ...
                        <ul class="sub-menu nav">
                            ...
                            <img src="/CLF/assets/img/1636.png" alt="">
                        </ul>
                    </li>
                    <li class="list-item list-item-has-children mega-menu mega-menu-col-5">
                ...
                <div class="row">
                    <div class="service-item col">
                        <a href=#/ target="_blank">
                            <img src="/CLF/assets/img/svg/delivery.svg">
                        </a>
                        <p>تحویل اکسپرس</p>
                    </div>
                    <div class="service-item col">
                        <a href=#/ target="_blank">
                            <img src="/CLF/assets/img/svg/contact-us.svg">
                        </a>
                        <p>پشتیبانی 24 ساعته</p>
                    </div>
                    <div class="service-item col">
                        <a href=#/ target="_blank">
                            <img src="/CLF/assets/img/svg/payment-terms.svg">
                        </a>
                        <p>پرداخت درمحل</p>
                    </div>
                    <div class="service-item col">
                        <a href=#/ target="_blank">
                            <img src="/CLF/assets/img/svg/return-policy.svg">
                        </a>
                        <p>۷ روز ضمانت بازگشت</p>
                    </div>
                    <div class="service-item col">
                        <a href=#/ target="_blank">
                            <img src="/CLF/assets/img/svg/origin-guarantee.svg">
                        </a>
            ...
            <div class="info">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 text-center">
                        <a href=#/ target="_blank"><img src="/CLF/assets/img/bazzar.png" width="159" height="48" alt=""></a>
                        <a href=#/ target="_blank"><img src="/CLF/assets/img/sibapp.png" width="159" height="48" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="symbol col-12 col-lg-5">
                        <a href=#/ target="_blank"><img src="/CLF/assets/img/symbol-01.png" alt=""></a>
                        <a href=#/ target="_blank"><img src="/CLF/assets/img/symbol-02.png" alt=""></a>
                    </div>
                    <div class="col-12">
                        <div class="row">
                            <ul class="footer-partners default">
                                <li class="col-md-3 col-sm-6">
                                    <a href=""><img src="/CLF/assets/img/footer/1.svg" alt=""></a>
                                </li>
                                <li class="col-md-3 col-sm-6">
                                    <a href=""><img src="/CLF/assets/img/footer/2.svg" alt=""></a>
                                </li>
                                <li class="col-md-3 col-sm-6">
                                    <a href=""><img src="/CLF/assets/img/footer/3.svg" alt=""></a>
                                </li>
                                <li class="col-md-3 col-sm-6">
                                    <a href=""><img src="/CLF/assets/img/footer/4.svg" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <!-- Some Scripts -->
    <script src="/CLF/assets/js/core/jquery.3.2.1.min.js" type="text/javascript"></script>
    <script src="/CLF/assets/js/core/popper.min.js" type="text/javascript"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-Fy6S3B9q64WdZWQUiU+q4/2Lc9npb8tCaSX9FK7E8HnRr0Jz8D6OP9dO5Vg3Q9ct" crossorigin="anonymous"></script>
    <!--  Plugin for Switches, full documentation here: http://www.jque.re/plugins/version3/bootstrap.switch/ -->
    <script src="/CLF/assets/js/plugins/bootstrap-switch.js"></script>
    <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
    <script src="/CLF/assets/js/plugins/nouislider.min.js" type="text/javascript"></script>
    <!--  Plugin for the DatePicker, full documentation here: https://github.com/uxsolutions/bootstrap-datepicker -->
    <script src="/CLF/assets/js/plugins/bootstrap-datepicker.js" type="text/javascript"></script>
    <!-- Share Library etc -->
    <script src="/CLF/assets/js/plugins/jquery.sharrre.js" type="text/javascript"></script>
    <!-- Control Center for Now Ui Kit: parallax effects, scripts for the example pages etc -->
    <script src="/CLF/assets/js/now-ui-kit.js" type="text/javascript"></script>
    <!--  CountDown -->
    <script src="/CLF/assets/js/plugins/countdown.min.js" type="text/javascript"></script>
    <!--  Plugin for Sliders -->
    <script src="/CLF/assets/js/plugins/owl.carousel.min.js" type="text/javascript"></script>
    <!--  Jquery easing -->
    <script src="/CLF/assets/js/plugins/jquery.easing.1.3.min.js" type="text/javascript"></script>
<!--  Plugin ez-plus -->
<script src="/CLF/assets/js/plugins/jquery.ez-plus.js" type="text/javascript"></script>
    <!-- Main Js -->
    <script src="/CLF/assets/js/main.js" type="text/javascript"></script>
</body>
</html>
