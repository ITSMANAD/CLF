...
//                    $ProductSpecs2 = \App\Models\Products_Specs::all()->whereIn('PID',$Product->id)->take(2);
            ...
            <div class="col-sm-5">
                ...
                @foreach($AttributesProduct as $AttributeProduct)
                    @php
                        $AttributeGroup = \App\Models\attributegroups::all()->find($AttributeProduct->attributegroup);
                    @endphp
                    <div>
                        ...
                        <div>
                            ...
                            @foreach($Attributes as $Attribute)
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="{{$AttributeGroup->id}}" id="{{$Attribute->id}}" value="{{$Attribute->id}}">
                                    <label class="form-check-label" for="{{$Attribute->id}}">{{$Attribute->name}}</label>
                                </div>
                            @endforeach
                        </div>
                    </div>
...
{{--                    @endforeach--}}
            ...
            <div class="col">
                <div class="rounded-3 m-1 shadow"
                    ...
                    <div class="d-grid gap-1 col-9 mx-auto">
                        <button class="btn shadow fs-5" onclick="AddToCart()" style="background-color: #EC2F01;"
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane params" id="params" role="tabpanel" aria-expanded="false">
                                            <article>
                                                ...
                                                @php
                                                    $Specs_Categories = \App\Models\Product_Specs_Category::all()->whereIn('PID',$Product->id);
                                                @endphp
                                                <section>
                                                        ...
                                                        <li>
                                                            <div class="comment-body">
                                                                <div class="comment-author">
                                                                    <img alt="" src="/CLF/assets/img/default-avatar.png"
                                                            ...
                                                            <ol class="children">
                                                                <li>
                                                                    <div class="comment-body">
                                                                        <div class="comment-author">
                                                                            <img alt=""
                                                                                 src="/CLF/assets/img/default-avatar.png"
    ...
    <script>
        function AddToCart() {
            var formData = new FormData(document.getElementById('Attributes'));
            axios.post('/shop/{{$Product->slug}}', {
                id: '{{$Product->id}}',
                Attributes: formData,
                csrf: '@csrf'
            })
                ...
                .catch(function (error) {
                    Swal.fire({
                        position: "center",
                        icon: "error",
                        title: "برای افزودن این محصول به سبد خرید باید وارد حساب خود شوید!",
                        footer: 'شما به صورت خودکار تا 5 ثانیه دیگر به صفحه ورود هدایت میشوید!',
                        showConfirmButton: false,
                        timer: 5000
                    });
