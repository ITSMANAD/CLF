                                ...
                                @foreach($h2 as $banner)
                                    <div class="col-lg-12 mb-1 mt-1" >
                                        <div class="widget-banner">
                                            <a href="{{$banner->blink}}">
                                                <img style="height: 226px!important;width: 452px!important;" src="{{$banner->bimage}}" alt="{{$banner->balt}}">
                                            </a>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <section id="main-slider"
                        ...
                        <ol class="carousel-indicators">
                            @foreach($h1 as $banner)
                                <li data-target="#main-slider" data-slide-to="{{$banner->balt}}"
                                    class="@if($banner->bname == "active") active @endif"></li>
                            @endforeach
                        </ol>
                            ...
                            @foreach($h1 as $banner)
                                <div class="carousel-item @if($banner->bname == "active") active @endif">
                                    <a class="main-slider-slide" href="{{$banner->blink}}">
                                        <img style="height: 461px" src="{{$banner->bimage}}" class="img-fluid img-respons">
                                    </a>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="widget widget-product card">
                        ...
                        <div class="row align-items-start">
                            <div class="col image-takhfif">
                                <img src="/CLF/assets/img/image.jpg" style="height: 359px;width: 331px" alt="">
                            </div>
                            <div class="col-9">
                                    ...
                                    <div class="owl-stage-outer">
                                        <div class="owl-stage"
                                            ...
                                            <div class="owl-item active"
                                                 style="width: 320px!important; margin-left: 10px;height: 359px">
                                                <div class="item">
                                                    <a href="#/">
                                                        <img src="/CLF/assets/img/product-slider/60eb20-200x200.jpg"
                                                             class="img-fluid" alt="">
                                                    </a>
                                                    <h2 class="post-title">
                                                    ...
                                                    <div class="price">
                                                        ...
                                                        <button class="btn"
                                                                style="border-radius: 15px;font-size: 12px;background-color: #FF4961;">
                                            ...
                                            <div class="owl-item active"
                                                 style="width: 320px!important; margin-left: 0;height: 359px">
                                                <div class="item">
                                                    <a href="#/">
                                                        <img src="/CLF/assets/img/product-slider/60eb20-200x200.jpg"
                                                             class="img-fluid" alt="">
                        ...
                        <div class="col-12">
                            <div class="widget widget-product card">
                                ...
                                <div class="product-carousel owl-carousel owl-theme owl-rtl owl-loaded owl-drag">
                                    ...
                                    <div class="owl-stage-outer">
                                        <div class="owl-stage"
                                             style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 800px!important;">
                                            @foreach($Posts as $Post)
                                                @php
                                                    $BlogCategory = \App\Models\BlogCategory::all()->whereIn('id',$Post->category)->first();
                                                @endphp
                                                <div class="owl-item active"
                                                     style="width: 334.313px!important; margin-left: 10px;">
                                                    <div class="item">
                                                        <a href="/shop/{{$Post->slug}}">
                                                            <img src="{{$Post->thumbnail}}"
                                                                 class="img-fluid w-50" alt="{{$Post->title}}">
                                                        </a>
                                                        <h2 class="post-title">
                                                        ...
                                                        <form action="{{route('BlogPost',$Post->slug)}}" method="GET">
                                                            <button type="submit" class="btn btn-info">مشاهده مقاله</button>
                                                        </form>
                    ...
                    {{--<section id="amazing-slider" class="carousel slide carousel-fade card" data-ride="carousel">
                        <div class="row m-0">
                            ...
                            <div class="carousel-inner p-0 col-12 col-lg-9">
                                <img class="amazing-title" src="/CLF/assets/img/amazing-slider/amazing-title-01.png" alt="">
                                <div class="carousel-item">
                                    <div class="row m-0">
                                        <div class="right-col col-5 d-flex align-items-center">
                                            <a class="w-100 text-center" href="#/">
                                                <img src="/CLF/assets/img/amazing-slider/60eb20-200x200.jpg"
                                                     class="img-fluid" alt="">
                                            </a>
                                        </div>
                                ...
                                <div class="carousel-item">
                                    <div class="row m-0">
                                        <div class="right-col col-5 d-flex align-items-center">
                                            <a class="w-100 text-center" href="#/">
                                                <img src="/CLF/assets/img/amazing-slider/4ff777-200x200.jpg"
                                                     class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="left-col col-7">
                                ...
                                <div class="carousel-item">
                                    <div class="row m-0">
                                        <div class="right-col col-5 d-flex align-items-center">
                                            <a class="w-100 text-center" href="#/">
                                                <img src="/CLF/assets/img/amazing-slider/35a2b8-200x200.jpg"
                                                     class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="left-col col-7">
                                ...
                                <div class="carousel-item finished active">
                                    <div class="row m-0">
                                        <div class="right-col col-5 d-flex align-items-center">
                                            <a class="w-100 text-center" href="#/">
                                                <img src="/CLF/assets/img/amazing-slider/c8297f-200x200.jpg"
                                                     class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="left-col col-7">
                                ...
                                <div class="carousel-item  finished">
                                    <div class="row m-0">
                                        <div class="right-col col-5 d-flex align-items-center">
                                            <a class="w-100 text-center" href="#/">
                                                <img src="/CLF/assets/img/amazing-slider/36855a-200x200.jpg"
                                                     class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="left-col col-7">
                                ...
                                <div class="carousel-item">
                                    <div class="row m-0">
                                        <div class="right-col col-5 d-flex align-items-center">
                                            <a class="w-100 text-center" href="#/">
                                                <img src="/CLF/assets/img/amazing-slider/0e6809-200x200.jpg"
                                                     class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="left-col col-7">
                                ...
                                <div class="carousel-item  finished">
                                    <div class="row m-0">
                                        <div class="right-col col-5 d-flex align-items-center">
                                            <a class="w-100 text-center" href="#/">
                                                <img src="/CLF/assets/img/amazing-slider/2d71f4-200x200.jpg"
                                                     class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="left-col col-7">
                                ...
                                <div class="carousel-item">
                                    <div class="row m-0">
                                        <div class="right-col col-5 d-flex align-items-center">
                                            <a class="w-100 text-center" href="#/">
                                                <img src="/CLF/assets/img/amazing-slider/59fc05-200x200.jpg"
                                                     class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="left-col col-7">
                                ...
                                <div class="carousel-item">
                                    <div class="row m-0">
                                        <div class="right-col col-5 d-flex align-items-center">
                                            <a class="w-100 text-center" href="#/">
                                                <img src="/CLF/assets/img/amazing-slider/8eb96c-200x200.jpg"
                                                     class="img-fluid" alt="">
                                            </a>
                                        </div>
                                        <div class="left-col col-7">
                                ...
                                <div class="col-12">
                                    @foreach($h3 as $banner)
                                        <div class="widget widget-banner card">
                                            <a href="{{$banner->blink}}">
                                                <img class="img-fluid" src="{{$banner->bimage}}"
                                                     alt="{{$banner->balt}}">
                                            </a>
                                        </div>
                                    @endforeach
                                            ...
                                            <div class="owl-item active"
                                                ...
                                                <div class="item">
                                                    <a href="/shop/{{$Product->slug}}">
                                                        <img src="{{$Product_Gallery->image}}"
                                                             class="img-fluid w-50" alt="{{$Product_Gallery->alt}}">
                                                    </a>
                                                    <h2 class="post-title">
                                                        <a class="fw-bold" href="#/">{{$Product->name}}</a>
                                                        <br>
                                                        <span>{{$Product_Brand->name}}</span>
                                                    </h2>

                                                    <div class="price">
                                                        <ins><span>{{number_format($Product_Price->price)}} <span>تومان</span></span></ins>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
                        ...
                        <div class="col-12">
                            <div class="brand-slider card">
                                ...
                                <div class="owl-carousel">
                                    @php
                                    $Brands = \App\Models\Brands::all()->take(5);
                                    @endphp
                                    @foreach($Brands as $Brand)
                                    <div class="item">
                                        <a >
                                            <img style="height: 167px!important;" class="img-fluid img-thumbnail mx-auto" src="{{$Brand->image}}" alt="{{$Brand->name}}">
                                        </a>
                                    </div>
                                    @endforeach
                                </div>
